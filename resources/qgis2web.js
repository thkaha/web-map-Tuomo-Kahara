...
map.getView().fit([3295453.538678, -1318551.424336, 4500720.085112, -111377.630657], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Forest Reserves and National Parks in Tanzania</h2>';
        return titleElement;
    })(),
